...
def export_solver(self, script_fname, out_fname=None, solver=None, solution=None, pause=False, autocontinue=True, import_from_older=True, log_level=None, **kwargs)
